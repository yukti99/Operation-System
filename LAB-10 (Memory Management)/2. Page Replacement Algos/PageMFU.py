	...
	for i  in pagestr:
		...
		if (i not in pf):
			...
			if ("X" in pf):
				...
				# gives the most frequently used page to replace with current page			
				j=0
				while(1):
...
def main():
	...
	print("MOST FREQUENTLY USED PAGE REPLACEMENT ALGORITHM")
